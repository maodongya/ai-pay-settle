...
> 版本：V1.3 | 日期：2026-07-14 | 类型：架构 / 业务 / 评审交付
...
**实现状态（V1.3）：** 当前代码为 **单体 Spring Boot**（`pay-app`），单库 `pay_settle` 含 18 表；MQ 默认本地模式。生产目标为 K8s 多服务 + **7 库垂直拆分** + Dubbo + Redis，详见 [分库分表.md](分库分表.md) 与 [02-开发手册](02-开发手册.md)。
